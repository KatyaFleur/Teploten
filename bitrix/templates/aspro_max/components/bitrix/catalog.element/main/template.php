					...
					<div class="brand-detail">
						<div class="brand-detail-info bordered rounded3">
							...
							<div class="brand-detail-info__preview">
								...
								<?endif;?>
								<?if($arResult['SECTION']):?>
									<div class="link font_xs"><a href="<?= $arResult['BRAND_ITEM']['CATALOG_PAGE_URL'] ?>" target="_blank"><?=GetMessage("ITEMS_BY_SECTION")?><?=GetMessage("ITEMS_BY_BRAND_MARKA", array("#BRAND#" => $arResult['BRAND_ITEM']["NAME"]))?></a></div>
								<?endif;?>
