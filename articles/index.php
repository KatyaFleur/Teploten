...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_LINK_NEWS_ID" => "63",
		"IBLOCK_LINK_SERVICES_ID" => "65",
		"IBLOCK_LINK_TIZERS_ID" => "53",
		"IBLOCK_LINK_REVIEWS_ID" => "62",
		"IBLOCK_LINK_STAFF_ID" => "59",
		"IBLOCK_LINK_VACANCY_ID" => "45",
		"IBLOCK_LINK_BLOG_ID" => "60",
		"IBLOCK_LINK_PROJECTS_ID" => "58",
		"IBLOCK_LINK_BRANDS_ID" => "73",
		"IBLOCK_LINK_LANDINGS_ID" => "60",
